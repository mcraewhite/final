...
# Create the users
puts "Creating users"
user_one = User.create(email:"test1@gmail.com",name: "Adam",password_digest:"password1234")

# Create the Players
puts "Creating players"
player_one = Player.create(user_id: user_one.id,seat_id: nil,is_dealer: false)
